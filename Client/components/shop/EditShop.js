...
import defaultShopImg from './../../images/shop.png'
    ...
    const updateShop = async (e) => {
        ...
        try {
            ...
            console.log( {
                ...
                ownerName: updateFormData.ownerName,
                phNumber: updateFormData.phNumber,
            ...
            alert('Failed to update shop, Try again!')
        }
    }
                                        ...
                                        <Form className="d-flex" >
                                            <Form.Group className="mb-3" controlId="formBasicName">
                                                <Form.Control type="text"
                                                    ...
                                                    name="name"
                                                    value={updateFormData?updateFormData.ownerName:''}
                                        ...
                                        <Form className="d-flex" >
                                            <Form.Group className="mb-3" controlId="formBasicName">
                                                <Form.Control type="text"
                                                    ...
                                                    name="email"
                                                    value={updateFormData.email?updateFormData.email:''}
                                        ...
                                        <Form className="d-flex" >
                                            <Form.Group className="mb-3" controlId="formBasicName">
                                                <Form.Control type="text"
                                                    ...
                                                    name="phNumber"
                                                    value={updateFormData?updateFormData.phNumber:''}
