...
import defaultShop from './../../images/shop.png'
                        ...
                        <Card.Body>
                            <Row>
                                ...
                                <Col sm={3}>
                                    ...
                                    <Row><span style={{ fontWeight: 'lighter', fontSize: 14 }}> sales: {shop.sales} | Joined in 2022</span><br /></Row>

                                    <Row><Button style={{ width: 'auto' }} className='rounded-pill' variant='outline-warning' onClick={() => setEditShop(true)}>Edit Shop</Button></Row>
                                </Col>
                                <Col sm={5}></Col>
                                <Col sm={2}>
                                    <Row><h6 >Owner Details</h6></Row>
                                    <Image rounded width={90} height={55} src={shopOwner} />
                                    <Row><span style={{ fontWeight: 'bold' }}>{shop.owner_name}</span></Row>
