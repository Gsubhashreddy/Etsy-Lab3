    ...
    const createNewShop = async (e) => {
        ...
        try {
            ...
            if(res.data){
                ...
                alert('Registered your new shop')
                setRegistered(true)
            }
        } catch (error) {
            //toast("Sorry! Try registering agian")
            alert('Sorry! Try registering agian')
        }
    }
        ...
        <Fragment>
            ...
            {nameAvailable && name && show && (
                <div style={{ marginLeft: "15%", marginRight: "15%", textAlign: 'center' }}>
                    ...
                    <Button variant="info" className='rounded-pill' onClick={(e)=>createNewShop(e)}>Register your new Shop</Button>
